...
public class PathAnimations extends Activity implements
    ...
    private void startAnimator(int checkedId) {
        ...
        if (checkedId == R.id.named_components) {// Use the named "x" and "y" properties for individual (x, y)
        ...
        } else if (checkedId == R.id.property_components) {// Use two Properties for individual (x, y) coordinates of the Path
            // and set them on the view object.
            // An int version of this method also exists for animating
            // int Properties.
            mAnimator = ObjectAnimator.ofFloat(view, View.X, View.Y, path);
        } else if (checkedId == R.id.multi_int) {// Use a multi-int setter to animate along a Path. The method
        ...
        } else if (checkedId == R.id.multi_float) {// Use a multi-float setter to animate along a Path. The method
        ...
        } else if (checkedId == R.id.named_setter) {// Use the named "point" property to animate along the Path.
        ...
        } else if (checkedId == R.id.property_setter) {// Use the POINT_PROPERTY property to animate along the Path.
